    ...
    <div className="flex min-h-screen bg-background">
      ...
      <main className="flex-1 ml-64">
        ...
        <div className="max-w-4xl mx-auto">
          <section id="about" className="py-16 px-8">
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-8">
              <div className="bg-card p-6 rounded-lg border border-border">
                <h3 className="text-lg font-bold text-primary mb-3">Amanah</h3>
                <p className="text-muted-foreground">
                  Menjaga kepercayaan jamaah dan mitra dengan pelayanan yang jujur dan transparan
                </p>
              </div>
              <div className="bg-card p-6 rounded-lg border border-border">
                <h3 className="text-lg font-bold text-primary mb-3">Legal</h3>
                <p className="text-muted-foreground">
                  Memastikan seluruh keberangkatan sesuai dengan regulasi pemerintah melalui PIHK resmi
                </p>
              </div>
              <div className="bg-card p-6 rounded-lg border border-border">
                <h3 className="text-lg font-bold text-primary mb-3">Nyaman</h3>
                <p className="text-muted-foreground">Menciptakan pengalaman ibadah yang tenang, tertib, dan berkesan</p>
              </div>
            </div>
          </section>
          ...
          <section id="why-pesantren" className="py-16 px-8 bg-card border-t border-border">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="space-y-6">
                ...
                <div>
                  <h3 className="text-xl font-bold text-primary mb-2">Pusat Pendidikan & Dakwah Umat</h3>
                  <p className="text-muted-foreground">
                    Pesantren menjadi tempat lahirnya ilmu, akhlak, dan dakwah yang membawa manfaat luas bagi
                    masyarakat.
                  </p>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-primary mb-2">Memiliki Basis Jamaah yang Kuat</h3>
                  <p className="text-muted-foreground">
                    Dengan adanya santri, wali santri, alumni, dan simpatisan, pesantren memiliki jaringan yang
                    potensial untuk difasilitasi.
                  </p>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-primary mb-2">Tingkat Kepercayaan Tinggi di Masyarakat</h3>
                  <p className="text-muted-foreground">
                    Pesantren dipandang sebagai lembaga yang amanah, sehingga jamaah merasa lebih tenang bila
                    keberangkatannya melalui rekomendasi pesantren.
                  </p>
                </div>
              </div>
              <div>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-accent/10 border border-accent/20 rounded-lg p-6">
                  ...
                  <p className="text-sm text-muted-foreground mt-2">Komisi yang diterima pesantren</p>
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div key={idx} className="bg-background border border-border rounded-lg overflow-hidden">
                  ...
                  <div className="p-6">
                    <p className="text-muted-foreground italic mb-3 line-clamp-3">"{testimonial.text}"</p>
          ...
          <section id="next-steps" className="py-16 px-8 bg-primary text-primary-foreground border-t border-border">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-4xl font-bold mb-8">LANGKAH BERIKUTNYA</h2>
                <div className="space-y-6">
                  <div className="flex gap-4">
                    <div className="text-3xl font-bold opacity-50 flex-shrink-0">01</div>
                    <div>
                      <h3 className="font-bold text-lg mb-2">Hubungi Tim Kami</h3>
                      <p className="opacity-90">
                        Silakan hubungi kami untuk informasi lebih lanjut tentang program kemitraan pesantren.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <div className="text-3xl font-bold opacity-50 flex-shrink-0">02</div>
                    <div>
                      <h3 className="font-bold text-lg mb-2">Diskusi Program</h3>
                      <p className="opacity-90">
                        Kami akan membahas kebutuhan spesifik pesantren Anda dan solusi terbaik.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <div className="text-3xl font-bold opacity-50 flex-shrink-0">03</div>
                    <div>
                      <h3 className="font-bold text-lg mb-2">Mulai Kerjasama</h3>
                      <p className="opacity-90">
                        Bergabunglah dengan pesantren mitra lainnya dalam mewujudkan perjalanan suci yang bermakna.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-8">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Permata Biru RW 001 RT 027
                  <br />
                  Desa Cinunuk, Kec. Cileunyi
                  <br />
